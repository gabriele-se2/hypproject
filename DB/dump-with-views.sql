...
--
-- Host: localhost    Database: my_hypprojectwebsite
-- ------------------------------------------------------
...
INSERT INTO `assistance` VALUES (1,'Configure an Email account on your smartphone','technical-support',0,'<p>Follow the following steps</p>\n<ol>\n    <li>Go to System Settings</li>\n    <li>Open \"Email\" submenu</li>\n    <li>Select \"Setup Wizard\"</li>\n    <li>Follow the steps of the wizard</li>\n</ol>\n\nIn case of problems, <a href=\"?page=contact-us\">contact us</a>.'),(2,'Use your mobile phone as modem','technical-support',1,'<ol>\n    <li>Ensure the TIM Mobile Hotspot feature is activated in your Settings or Manage Connections area.</li>\n    <li>Open the App Tray and select \"Mobile Hotspot.\"</li>\n    <li>Tap the Mobile Hotspot checkbox.</li>\n    <li>In a few moments, an icon will appear in the notifications panel showing the availability of your new hotspot.</li>\n    <li>Computers and other connected devices can now connect to this hotspot through Wi-Fi and share your smartphone\'s data connection.</li>\n</ol>'),(3,'Change your mobile plan','line-management',0,'<p>To change your mobile plan, you simply have to:</p>\n<ul>\n    <li>Call 231932 from your line</li>\n    <li>Follow the instructions</li>\n</ul>\n<p>You should receive a confirmation via SMS immediately.</p>\n<p>It will take at least 24h for your request to be processed completely. You\'ll receive another SMS when the request has been processed completely.</p>'),(4,'Disable your Netflix subscription','digital-services',1,'<p>To change your mobile plan, you simply have to:</p>\n<ul>\n    <li>Call 231932 from your line</li>\n    <li>Follow the instructions</li>\n</ul>\n<p>You should receive a confirmation via SMS immediately.</p>\n<p>It will take at least 24h for your request to be processed completely. You\'ll receive another SMS when the request has been processed completely.</p>'),(5,'Find the current credit of your line','bills',1,'<p>Send an SMS to 12312432 with the following content</p>\n<pre>credit</pre>\n<p>You\'ll immediately receive an SMS reporting your current credit.</p>');
...
DROP TABLE IF EXISTS `assistance_for`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
LOCK TABLES `assistance_for` WRITE;
/*!40000 ALTER TABLE `assistance_for` DISABLE KEYS */;
INSERT INTO `assistance_for` VALUES (1,1,1,'smartphone'),(2,1,2,'smartphone'),(3,1,3,'smartphone'),(4,1,4,'smartphone'),(5,4,1,'smartlife'),(6,1,5,'smartphone'),(7,1,6,'smartphone'),(8,1,7,'smartphone'),(9,1,8,'smartphone'),(10,1,9,'smartphone'),(11,4,10,'smartphone'),(12,4,11,'smartphone'),(13,4,12,'smartphone'),(14,3,13,'smartphone'),(15,3,14,'smartphone'),(16,1,15,'tablet'),(17,1,15,'tablet'),(18,2,1,'smartphone'),(19,3,2,'smartphone'),(20,5,3,'smartphone'),(21,3,5,'smartphone'),(22,3,10,'smartphone'),(23,5,11,'smartphone'),(24,5,6,'smartphone'),(25,5,2,'smartphone'),(26,4,3,'smartphone'),(27,4,10,'smartphone'),(28,4,16,'tablet');
/*!40000 ALTER TABLE `assistance_for` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `devices` VALUES (1,'Apple','iPhone SE',509.90),(2,'Samsung','Galaxy S7',729.90),(3,'Sony','Xperia X',629.90),(4,'Samsung','Galaxy J5',229.90),(5,'LG','K8',179.90),(6,'Huawei','P9 Plus',749.90),(7,'LG','G5',699.90),(8,'Microsoft','LUMIA 950',499.90),(9,'Samsung','Galaxy Grand',179.90),(10,'Huawei','P8 lite smart',199.90),(11,'Microsoft','LUMIA 950 XL',699.90),(12,'LG','X screen',249.90),(13,'LG','Nexus 5',449.90),(14,'Apple','iPhone 5s',329.90),(15,'Apple','iPad Pro',1199.90),(16,'Samsung','Galaxy Tab S2 9.7 VE',549.90);
...
INSERT INTO `sales` VALUES (1,123),(6,119),(15,432);
...
INSERT INTO `smartlife` VALUES (1,'Netflix','Enjoy your favorite shows with our special Netflix options.','tv-entertainment','Netflix is a subscription-based film and television program rental service that offers media to subscribers via Internet streaming.\nThanks to our mobile service, Netflix allows you to watch your favorite shows and movies wherever you are and whenever you want.','The monthly cost is automatically detracted from your credit at the beginning of every month.'),(2,'TIM Music','Enjoy your favorite songs wherever you want and whenever you want','tv-entertainment','TIM Music is a music streaming service that allows you to listen to your favorite songs and artist wherever you are and whenever you want.\nAll you need to use the service is a compatible device.','The monthly cost is automatically detracted from your credit at the beginning of every month.'),(3,'TIM Vision','On demand movies, TV series, documentaries and concerts to create your own schedule without advertising. More than 8,000 titles on a subscription, with no time constraints, even in HD.','tv-entertainment','On demand movies, TV series, documentaries and concerts to create your own schedule without advertising. More than 8,000 titles on a subscription, with no time constraints, even in HD.','The monthly cost is automatically detracted from your credit at the beginning of every month.');
/*!40000 ALTER TABLE `smartlife` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `smartlife_options`
--

DROP TABLE IF EXISTS `smartlife_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `smartlife_options` (
...
--
-- Dumping data for table `smartlife_options`
--

LOCK TABLES `smartlife_options` WRITE;
/*!40000 ALTER TABLE `smartlife_options` DISABLE KEYS */;
INSERT INTO `smartlife_options` VALUES (1,1,'Netflix Base','7.99','One streaming session'),(2,1,'Netflix Standard','9.99','Two simultaneous streaming sessions'),(3,1,'Netflix Premium','11.99','Four simultaneous streaming sessions'),(4,2,'TIM Music','7.99','One streaming session'),(5,3,'TIM Vision','23.12','');
/*!40000 ALTER TABLE `smartlife_options` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `smartphones` VALUES (1,'iOS','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','Retina display, 4inch (diagonal)','Apple A9 a 64 bit','113 g','123.8mm x 58.6mm x 7.6mm (H x W x D)','12 megapixel iSight camera with 1.22µ pixels'),(2,'Android','Explore the Samsung Galaxy S7 edge—big on screen and slim on profile with an edge.\nCrisp, bright display on 5.5\" Quad HD Super AMOLED screen with dynamic, contoured dual edge display.\nWater & dust resistance that repels splashes and dunks.\nSharper low-light images with the world’s first dual-pixel smartphone camera.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(3,'Android','The most shareable moments tend to be the hardest to capture. To help you get the shots you want, we made our flagship camera faster and smarter than ever – with quicker response times and even more intelligent focus. Xperia X’s Smart Capture technology helps you banish blur. Enabled by Sony’s new Predictive Hybrid Autofocus, Smart Capture lets you choose a person or object and automatically track it. Now your subject stays in focus, even when moving, and the most unpredictable scenes come out in the sharpest detail.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(4,'Android','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(5,'Android','Explore the Samsung Galaxy S7 edge—big on screen and slim on profile with an edge.\nCrisp, bright display on 5.5\" Quad HD Super AMOLED screen with dynamic, contoured dual edge display.\nWater & dust resistance that repels splashes and dunks.\nSharper low-light images with the world’s first dual-pixel smartphone camera.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(6,'Android','The most shareable moments tend to be the hardest to capture. To help you get the shots you want, we made our flagship camera faster and smarter than ever – with quicker response times and even more intelligent focus. Xperia X’s Smart Capture technology helps you banish blur. Enabled by Sony’s new Predictive Hybrid Autofocus, Smart Capture lets you choose a person or object and automatically track it. Now your subject stays in focus, even when moving, and the most unpredictable scenes come out in the sharpest detail.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(7,'Android','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(8,'Windows Phone','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(9,'Android','Explore the Samsung Galaxy S7 edge—big on screen and slim on profile with an edge.\nCrisp, bright display on 5.5\" Quad HD Super AMOLED screen with dynamic, contoured dual edge display.\nWater & dust resistance that repels splashes and dunks.\nSharper low-light images with the world’s first dual-pixel smartphone camera.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(10,'Android','The most shareable moments tend to be the hardest to capture. To help you get the shots you want, we made our flagship camera faster and smarter than ever – with quicker response times and even more intelligent focus. Xperia X’s Smart Capture technology helps you banish blur. Enabled by Sony’s new Predictive Hybrid Autofocus, Smart Capture lets you choose a person or object and automatically track it. Now your subject stays in focus, even when moving, and the most unpredictable scenes come out in the sharpest detail.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(11,'Windows Phone','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(12,'Android','Explore the Samsung Galaxy S7 edge—big on screen and slim on profile with an edge.\nCrisp, bright display on 5.5\" Quad HD Super AMOLED screen with dynamic, contoured dual edge display.\nWater & dust resistance that repels splashes and dunks.\nSharper low-light images with the world’s first dual-pixel smartphone camera.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(13,'Android','The most shareable moments tend to be the hardest to capture. To help you get the shots you want, we made our flagship camera faster and smarter than ever – with quicker response times and even more intelligent focus. Xperia X’s Smart Capture technology helps you banish blur. Enabled by Sony’s new Predictive Hybrid Autofocus, Smart Capture lets you choose a person or object and automatically track it. Now your subject stays in focus, even when moving, and the most unpredictable scenes come out in the sharpest detail.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Samsung Exynos 8890','152 g','142.4 mm x 169.6 mm x 7.9 mm (H x W x D)','Samsung ISOCELL S5K2L1 or Sony Exmor R IMX260'),(14,'iOS','Welcome to iPhone SE, the most powerful 4 inch phone ever. Created from a beloved design, then reinvented from the inside out. The A9 is the same advanced chip used in iPhone 6s. The 12 megapixel camera captures incredible photos and 4K videos. And Live Photos bring your images to life. The result is an iPhone that looks small, but lives large.','5.1 in, Quad HD Super AMOLED 2560×1440 pixel ','Apple A9 a 64 bit','152 g','123.8mm x 58.6mm x 7.6mm (H x W x D)','12 megapixel iSight camera with 1.22µ pixels');
/*!40000 ALTER TABLE `smartphones` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `smartphones_view`
--

DROP TABLE IF EXISTS `smartphones_view`;
/*!50001 DROP VIEW IF EXISTS `smartphones_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `smartphones_view` AS SELECT 
 1 AS `id`,
 1 AS `os`,
 1 AS `description`,
 1 AS `screen`,
...
INSERT INTO `tablets` VALUES (15,'iOS','iPad Pro is more than the next generation of ','2732x2048 px (264 PPI), 12.9 in (330 mm) diag','2.24 GHz dual-core 64-bit ARMv8-A','713 g','305.7 mm x 220.6 mm x 6.9 mm (H x W x D)','720p Front-facing and 8 megapixels rear-facin'),(16,'Android','Slimmer for a Comfortable Fit in the Hand You','2732x2048 px (264 PPI), 12.9 in (330 mm) diag','2.24 GHz dual-core 64-bit ARMv8-A','713 g','305.7 mm x 220.6 mm x 6.9 mm (H x W x D)','720p Front-facing and 8 megapixels rear-facin');
/*!40000 ALTER TABLE `tablets` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `tablets_view`
--

DROP TABLE IF EXISTS `tablets_view`;
/*!50001 DROP VIEW IF EXISTS `tablets_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `tablets_view` AS SELECT 
 1 AS `id`,
 1 AS `os`,
 1 AS `description`,
 1 AS `screen`,
...
--
-- Final view structure for view `product_sales_view`
--
...
/*!50001 VIEW `product_sales_view` AS select `sales`.`id` AS `id`,`sales`.`discounted_price` AS `discounted_price`,`devices`.`manufacturer` AS `manufacturer`,`devices`.`name` AS `name`,`devices`.`price` AS `price`,`smartphones`.`os` AS `os`,`smartphones`.`description` AS `description`,'smartphone' AS `category` from ((`sales` join `devices` on((`sales`.`id` = `devices`.`id`))) join `smartphones` on((`sales`.`id` = `smartphones`.`id`))) union select `sales`.`id` AS `id`,`sales`.`discounted_price` AS `discounted_price`,`devices`.`manufacturer` AS `manufacturer`,`devices`.`name` AS `name`,`devices`.`price` AS `price`,`tablets`.`os` AS `os`,`tablets`.`description` AS `description`,'tablet' AS `category` from ((`sales` join `devices` on((`sales`.`id` = `devices`.`id`))) join `tablets` on((`sales`.`id` = `tablets`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `smartphones_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `smartphones_view` AS select `smartphones`.`id` AS `id`,`smartphones`.`os` AS `os`,`smartphones`.`description` AS `description`,`smartphones`.`screen` AS `screen`,`smartphones`.`cpu` AS `cpu`,`smartphones`.`weight` AS `weight`,`smartphones`.`size` AS `size`,`smartphones`.`camera` AS `camera`,`devices`.`manufacturer` AS `manufacturer`,`devices`.`name` AS `name`,`devices`.`price` AS `price` from (`smartphones` join `devices` on((`smartphones`.`id` = `devices`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `tablets_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `tablets_view` AS select `tablets`.`id` AS `id`,`tablets`.`os` AS `os`,`tablets`.`description` AS `description`,`tablets`.`screen` AS `screen`,`tablets`.`cpu` AS `cpu`,`tablets`.`weight` AS `weight`,`tablets`.`size` AS `size`,`tablets`.`camera` AS `camera`,`devices`.`manufacturer` AS `manufacturer`,`devices`.`name` AS `name`,`devices`.`price` AS `price` from (`tablets` join `devices` on((`tablets`.`id` = `devices`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2016-07-19 16:18:08
